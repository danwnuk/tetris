...
namespace Tetris
{
    class BlueShape : Composite
    {
        private int numStates = 4;
        public BlueShape()
        {
            color = Color.Blue;
            Rectangle rect = new Rectangle((420 / 2) - 60, -30, 30, 30);
            Rectangle rect2 = new Rectangle((420 / 2) - 60, 0, 30, 30);
        ...
        public override void increaseState()
        {
            ...
            else if (state == 2)
            {
                ...
                list2.Add(new Rectangle(list.ElementAt(1).X+60, list.ElementAt(1).Y, 30, 30));
            ...
            else if (state == 3)
            {
                state = 4;
                List<Rectangle> list2 = new List<Rectangle>();
                list2.Add(new Rectangle(list.ElementAt(0).X-60, list.ElementAt(0).Y+30, 30, 30));
                list2.Add(new Rectangle(list.ElementAt(1).X-30, list.ElementAt(1).Y+60, 30, 30));
